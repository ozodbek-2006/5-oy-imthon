document.addEventListener('DOMContentLoaded', function () {
    ...
    selected_data = [
        {"name": "Car A", "price": 12000},
        {"name": "Car B", "price": 15000},
        {"name": "Car C", "price": 18000}
    ]
    ...
    async function Products1() {
        try {
            ...
            let AllProducts = await fetch('https://cars-pagination.onrender.com/products/filter?minPrice=10000&maxPrice=24500')
            ...
            for (let i = 0; i < 5; i++) {
                let HtmlProducts = `
                        <div class="products_div" data-id='${products.id}'>
                                    <div>
                                    <img src="${products.image}" alt="" class="images22">
                                        <div class="nalichiCros_sale">
                                            ...
                                            <button class="sale" data-id='${products.id}'>SALE</button>
                                        </div>
                                    ...
                                    <div class="products_info">
                                        ...
                                        <p class="texts_info">${products.name}</p>
                                        <h1 class="moneyRubl">${products.newPrice}₽ <span>${products.oldPrice}₽</h1>
                                    </div>
                                </div>
                        `
